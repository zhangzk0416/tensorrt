...
bool build_model() {
	...
	if (!parser->parseFromFile("F:/tensorrt-integrate/1.2-yolov5-detect/yolov5-6.0-change/yolov5s.onnx", 1)) {
...
void inference() {
	...
	///////////////////////////////////////////////////
	// letter box
	auto image = cv::imread("F:/tensorrt-integrate/1.2-yolov5-detect/yolov5-6.0-change/data/images/bus.jpg");
	// 通过双线性插值对图像进行resize
	...
	cv::imwrite("F:/and/input-image.jpg", input_image);
	...
	cv::imwrite("F:/and/image-draw.jpg", image);
